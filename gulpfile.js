...
gulp.task(
    "browser-sync",
    ["html:build", "styles:build", "js:build", "images:build", "fonts:build"],
    function () {
        var files = [folders.dst + "*.*"];
...
gulp.task("images:build", function () {
    gulp.src(path.src.images).pipe(gulp.dest(path.build.images));
});
